...
const BentoCard = ({ src,title,description }) => {
    return (
        <div className="relative size-full">
            ...
            />
            <div className="relative z-10 flex size-full flex-col justofy-between p-5 text-blue-50">
                <div>
      ...
      <section className="bg-black pb-52">
          <div className="container max-auto px-3 md:px-10">
              <div className="px-5 py-32">
                  ...
                  <p className="max-w-md font-circular-web text-lg text-blue-50 ipacity-50">
              ...
              <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                  <BentoTilt className="bento-tilt_1 row-span_1 md:col-span-1 md:row-span-2">
                      <BentoCard
                  ...
                  <BentoTilt className="bento-tilt_2">
                      <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                          <h1 className="bento-title special-font max-w-64 text-black">More c<b>0</b>ming so<b>o</b>n</h1>
